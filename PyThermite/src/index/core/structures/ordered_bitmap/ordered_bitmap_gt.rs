...
macro_rules! define_get_gt {
    ...
    ($name:ident, $feat:literal) => {
        ...
        unsafe fn $name(&self, value: u128, out: &mut Bitmap) {
            define_get_gt_body!(self, value, out);
        }
    };
...
macro_rules! define_get_gte {
    ...
    ($name:ident, $feat:literal) => {
        #[target_feature(enable = $feat)]
        unsafe fn $name(&self, value: u128, out: &mut Bitmap) {
            define_get_gte_body!(self, value, out);
        }
    };
...
impl NumericalBitmap {
    ...
    #[inline(always)]
    pub fn get_gt_into(&self, value: u128, out: &mut Bitmap) {
        let f = self.get_gt_impl();
        unsafe { f(self, value, out) }
    }

    #[inline(always)]
    pub fn get_gte_into(&self, value: u128, out: &mut Bitmap) {
    ...
    pub fn get_gt(&self, value: u128) -> Bitmap {
        ...
        self.get_gt_into(value, &mut res);
        res
    }
    ...
    pub fn get_gte(&self, value: u128) -> Bitmap {
        let mut res = Bitmap::new();
        self.get_gte_into(value, &mut res);
        res
    }
...
mod tests {
    ...
    fn gt_same_prefix_different_lsb() {
        ...
        idx.get_gt_into(0b101000, &mut out);
    ...
    fn gt_first_differing_bit_high() {
        ...
        idx.get_gt_into(0b011111, &mut out);
    ...
    fn gt_first_differing_bit_low() {
        ...
        idx.get_gt_into(0b111100, &mut out);
    ...
    fn gt_highest_bit_boundary() {
        ...
        idx.get_gt_into(high - 1, &mut out);
