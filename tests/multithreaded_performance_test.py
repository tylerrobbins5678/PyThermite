    ...
    make_data = [
        Record(
            **{
                ...
                "4_id": i,
                "4_age": np.random.randint(18, 80),
                "4_score": np.random.rand() * 100,
                "4_active": np.random.choice([True, False]),
                "4_country": np.random.choice(["US", "CA", "MX", "FR", "DE"]),
                "4_group": random_str(),
                "4_tags": np.random.choice(["a", "b", "c", "d"]),
                "3_id": i,
                "3_age": np.random.randint(18, 80),
                "3_score": np.random.rand() * 100,
                "3_active": np.random.choice([True, False]),
                "3_country": np.random.choice(["US", "CA", "MX", "FR", "DE"]),
                "3_group": random_str(),
                "3_tags": np.random.choice(["a", "b", "c", "d"]),
                "2_id": i,
                "2_age": np.random.randint(18, 80),
                "2_score": np.random.rand() * 100,
                "2_active": np.random.choice([True, False]),
                "2_country": np.random.choice(["US", "CA", "MX", "FR", "DE"]),
                "2_group": random_str(),
                "2_tags": np.random.choice(["a", "b", "c", "d"]),
                "1_id": i,
                "1_age": np.random.randint(18, 80),
                "1_score": np.random.rand() * 100,
                "1_active": np.random.choice([True, False]),
                "1_country": np.random.choice(["US", "CA", "MX", "FR", "DE"]),
                "1_group": random_str(),
                "1_tags": np.random.choice(["a", "b", "c", "d"]),
            }
        )
        for i in range(size)
    ]
